...
/**
 * @file
 * Contains Drupal\commerce\Form\StoreDeleteForm
 */
 ...
 */
class StoreDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('entity.commerce_store.collection');
  }
