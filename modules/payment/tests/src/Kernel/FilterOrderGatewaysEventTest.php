...
/**
 * Tests the FilterOrderGatewaysEvent.
 *
 * @group commerce
 */
class FilterOrderGatewaysEventTest extends CommerceKernelTestBase {
  ...
  public function testEvent() {
    ...
    $order->setData('test_filtered_gateways', [$payment_gateway_filtered->id()]);
