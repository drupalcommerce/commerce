...
class OrderTest extends CommerceKernelTestBase {
  ...
  public function testOrder() {
    ...
    $this->assertEquals($adjustments[0]->getAmount(), $collected_adjustments[0]['amount']);
    $this->assertEquals($adjustments[1]->getAmount(), $collected_adjustments[1]['amount']);
    ...
    $collected_adjustments = $order->collectAdjustments();
    $this->assertEquals(new Price('10.00', 'USD'), $collected_adjustments[2]['amount']);
