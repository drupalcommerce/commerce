 ...
 * @group commerce
 */
class OrderReceiptMultilingualTest extends CommerceKernelTestBase {
   ...
   */
  public function testOrderReceiptMultilingual($langcode, $expected_langcode, $expected_subject, $expected_store_label, $expected_thank_you_text, $expected_order_total) {
    ...
    $email = reset($emails);
    self::assertEquals($expected_langcode, $email['langcode']);
    self::assertEquals($expected_subject, $email['subject']);
    self::assertContains($expected_store_label, $email['body']);
    self::assertContains($expected_thank_you_text, $email['body']);
    self::assertContains($expected_order_total, $email['body']);
  }
