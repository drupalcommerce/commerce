...
class OrderTypeForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['emails']['notice'] = [
      '#markup' => '<p>' . $this->t('Emails are sent in the HTML format. You will need a module like <a href="https://www.drupal.org/project/swiftmailer">Swiftmailer</a> to send HTML emails. This has only been tested with the Swiftmailer module.') . '</p>',
    ];
    ...
    $form['emails']['receiptBcc'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Send a copy of the receipt to the store email'),
      '#default_value' => ($order_type->isNew()) ? TRUE : $order_type->shouldAddReceiptBcc(),
      '#states' => [
        'visible' => [
