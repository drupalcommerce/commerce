...
/**
 * @file
 * Contains \Drupal\commerce_order\Plugin\Action\DeleteOrder.
 */
 ...
 *
 * @Action(
 *   id = "delete_order_action",
 *   label = @Translation("Delete order"),
 *   type = "commerce_order",
 *   confirm_form_route_name = "entity.commerce_order.multiple_delete_confirm"
 * )
 */
class DeleteOrder extends ActionBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new DeleteOrder object.
   *
