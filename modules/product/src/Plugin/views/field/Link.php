...
/**
 * @file
 * Definition of Drupal\commerce_product\Plugin\views\field\Link.
 */
...
/**
 * Field handler to present a link to the commerce product.
 *
...
class Link extends FieldPluginBase {
  ...
  /**
   * Prepares the link to the commerce product.
   *
  ...
  protected function renderLink($commerce_product, ResultRow $values) {
    if ($commerce_product->access('view')) {
      $this->options['alter']['make_link'] = TRUE;
      $this->options['alter']['path'] = 'product/' . $commerce_product->id();
