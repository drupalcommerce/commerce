...
/**
 * Revert the default order item add_to_cart mode form display.
 */
function commerce_product_post_update_5() {
  ...
  /** @var \Drupal\commerce\Config\ConfigUpdaterInterface $config_updater */
  $config_updater = \Drupal::service('commerce.config_updater');
  $result = $config_updater->revert(['core.entity_form_display.commerce_order_item.default.add_to_cart'], FALSE);
